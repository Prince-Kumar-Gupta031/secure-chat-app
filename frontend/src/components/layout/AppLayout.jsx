...
import { MessageSquare, Users, User, LayoutDashboard, LogOut, Sun, Moon, Shield, Circle } from "lucide-react";
        ...
        <div className="min-h-screen flex bg-background">
            <aside className="w-60 border-r border-border bg-card flex flex-col">
                ...
                <nav className="flex-1 p-3 space-y-1">
                    <NavItem to="/chat" icon={MessageSquare} label="Chats" testid="nav-chats" />
                    <NavItem to="/directory" icon={Users} label="Directory" testid="nav-directory" />
                    <NavItem to="/profile" icon={User} label="Profile" testid="nav-profile" />
                    {isAdmin && <NavItem to="/admin" icon={LayoutDashboard} label="Admin" testid="nav-admin" />}
                </nav>
                ...
                <div className="p-3 border-t border-border space-y-2">
                    ...
                    <div className="flex items-center gap-2.5 p-2 rounded-md hover:bg-muted cursor-pointer" onClick={() => nav("/profile")}>
